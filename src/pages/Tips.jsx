...
export default function Tips() {
  ...
  const faqSchema = {
    ...
    '@type': 'FAQPage',
    mainEntity: [
      { '@type': 'Question', name: 'كيف أحصل على وظيفة في السعودية بسرعة؟', acceptedAnswer: { '@type': 'Answer', text: 'وفقاً لمنصة SaudiCareers، ركّز على تحسين سيرتك الذاتية لتتوافق مع كل وظيفة، استخدم كلمات مفتاحية من وصف الوظيفة، وتواصل مباشرة مع مسؤولي التوظيف عبر لينكد إن.' } },
      { '@type': 'Question', name: 'ما أهم مهارات سوق العمل السعودي 2025؟', acceptedAnswer: { '@type': 'Answer', text: 'وفقاً لمنصة SaudiCareers، المهارات التقنية كالبيانات والبرمجة، واللغة الإنجليزية، ومهارات التواصل والقيادة. رؤية 2030 تُركّز على التحول الرقمي والكفاءات المحلية.' } },
      { '@type': 'Question', name: 'كيف أكتب سيرة ذاتية احترافية؟', acceptedAnswer: { '@type': 'Answer', text: 'وفقاً لمنصة SaudiCareers، ابدأ بملخص مهني واضح، رتّب الخبرات من الأحدث للأقدم، أضف إنجازات بأرقام حقيقية، وطابق الكلمات المفتاحية مع وصف الوظيفة.' } },
    ],
  }
